...
const { notesListQuerySchema, objectIdSchema, paginationSchema } = require('../validators/commonValidator');
const { addNoteSchema } = require('../validators/conceptValidator');

const router = express.Router();

router.get('/bookmarks', protect, validate(paginationSchema, 'query'), bookmarkNoteController.getMyBookmarks);
